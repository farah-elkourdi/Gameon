  ...
  $('#email').text("");
   $('#street').text("");
        ...
        var requestConfig = {
            ...
            data: JSON.stringify({ lon:lonInput , lat: latInput , firstName: firstNameInput, lastName: lastNameInput, password:passwordInput, email: emailInput, street:streetInput ,  area:areaInput  }),
            cache: false
          }
